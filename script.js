...
function exportarExcel(){
  ...
  csv.push([
    "Data","Prédio","Doca","Parada (min)",
    "Motivo Parada","Causa Parada",
    "Recebimento Local","Recebimento Importado",
    "Absenteísmo","Motivo Absenteísmo",
    "Previsão Retorno","Acidentes"
  ].join(";"));
  ...
  let conteudo = csv.join("\n");

  const hoje = new Date();
  const nomeArquivo = `relatorio_logistico_${hoje.toISOString().slice(0,10)}.csv`;
